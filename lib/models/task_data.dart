class Task {
  ...
  factory Task.fromJson(Map<String, dynamic> json) {
    ...
    // old tasks created before this field existed default to false
  ...
  Map<String, dynamic> toJson() {
    ...
    if (sharedWith != null) data['sharedWith'] = sharedWith;
    if (sharedBy != null) data['sharedBy'] = sharedBy;

    return data;
  }

  // sentinel that lets copyWith distinguish "caller passed null" from "caller omitted the field"
  ...
  Task copyWith({
    ...
    String? username,
    DateTime? date,
    Object? duedate = _absent, // Object? so callers can pass null to clear the date
    String? description,
    String? sharedWith,
    String? sharedBy,
    bool? isCompleted,
