...
class TaskCardWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      ...
      DateTime dateToShow = task.duedate ?? task.date;
      String formattedDate = DateFormat('MMM dd, yyyy').format(dateToShow);

      Color borderColor = isOverdue ? Colors.red.shade200 : Colors.grey.shade200;
      Color cardColor   = task.isCompleted ? Colors.grey.shade50 : Colors.white;
